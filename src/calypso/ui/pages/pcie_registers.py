...
def pcie_registers_page(device_id: str) -> None:
    ...
    with ui.column().classes("w-full p-4 gap-4"):
        ui.label("PCIe Registers").classes("text-h5").style(
                    ...
                    with ui.row().classes("w-full gap-4"):
                        with ui.column().classes("flex-1"):
                            ...
                            for field in [
                                ...
                                color = COLORS["accent_red"] if val else COLORS["text_muted"]
                                ui.label(
                        ...
                        with ui.column().classes("flex-1"):
                            ...
                            for field in [
                                ...
                                color = COLORS["accent_yellow"] if val else COLORS["text_muted"]
                                ui.label(
                                    f"{'!!' if val else '  '} {field.replace('_', ' ')}"
                                ).style(f"color: {color}; font-family: monospace; font-size: 13px")
